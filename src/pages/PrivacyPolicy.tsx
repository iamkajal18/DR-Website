            ...
            <div className="space-y-8 text-gray-700">
              <div>
                ...
                <p className="leading-relaxed">
                  At Ratna Homoeo Clinic, we are committed to protecting your
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    ...
                    phone number, date of birth, and medical history when you
                    book an appointment or register as a patient.
                  </li>
                  <li>
                    <strong>Health Information:</strong> Medical conditions,
                    symptoms, treatment history, and other health-related data
                    necessary for providing homeopathic care.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    correspondence with us through email, phone, or other
                    channels.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    To protect the rights, property, or safety of our clinic,
                    patients, or others
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  ...
                  analyze web traffic and remember your preferences. You can
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  ...
                  children without parental consent. If you believe we have
